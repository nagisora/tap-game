...
export const scenes = [
  {
    ...
    animals: [
      ...
      { id: "chicken", art: "assets/art/farm/chicken.svg", audio: "assets/audio/chicken.mp3", x: 0.72, y: 0.34 },
      { id: "sheep", art: "assets/art/farm/sheep.svg", audio: "assets/audio/sheep.mp3", x: 0.78, y: 0.68 },
    ],
  },
  {
    id: "yard",
    ...
    animals: [
      ...
      { id: "duck", art: "assets/art/yard/duck.svg", audio: "assets/audio/duck.mp3", x: 0.74, y: 0.4 },
  ...
  },
  {
    ...
    animals: [
      ...
      { id: "penguin", art: "assets/art/sea/penguin.svg", audio: "assets/audio/penguin.mp3", x: 0.76, y: 0.4 },
